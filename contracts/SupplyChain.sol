...
contract SupplyChain {
    ...
    function startShipment(
        ...
        require(shipment.status == ShipmentStatus.PENDING, "Shipment is already in progress");

        shipment.status = ShipmentStatus.SHIPPED;
        typeShipment.status = ShipmentStatus.SHIPPED;

        emit ShipmentShipped(_sender, _receiver, shipment.pickupTime);
    }
    ...
    function completeShipment(
        ...
        require(shipment.receiver == _receiver, "Invalid receiver");
        require(shipment.status == ShipmentStatus.SHIPPED, "Shipment is not in progress yet");
